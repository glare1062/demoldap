...
//				exception.getMessage(), exception);
		Throwable cause = new TestActiveDirectoryAuthenticationException(hexString,
				exception.getMessage(), exception);
		switch (code) {
...
final class TestActiveDirectoryAuthenticationException extends AuthenticationException{
	private final String dataCode;

	TestActiveDirectoryAuthenticationException(String dataCode, String message,
										   Throwable cause) {
//		super(message, cause);
